...
public class ProductCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static io.github.mitohondriyaa.product.event.ProductCreatedEvent.Builder newBuilder() {
    return new io.github.mitohondriyaa.product.event.ProductCreatedEvent.Builder();
  }
   ...
   * @return A new ProductCreatedEvent RecordBuilder
   */
  public static io.github.mitohondriyaa.product.event.ProductCreatedEvent.Builder newBuilder(io.github.mitohondriyaa.product.event.ProductCreatedEvent.Builder other) {
    if (other == null) {
      return new io.github.mitohondriyaa.product.event.ProductCreatedEvent.Builder();
    } else {
      return new io.github.mitohondriyaa.product.event.ProductCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new ProductCreatedEvent RecordBuilder
   */
  public static io.github.mitohondriyaa.product.event.ProductCreatedEvent.Builder newBuilder(io.github.mitohondriyaa.product.event.ProductCreatedEvent other) {
    if (other == null) {
      return new io.github.mitohondriyaa.product.event.ProductCreatedEvent.Builder();
    } else {
      return new io.github.mitohondriyaa.product.event.ProductCreatedEvent.Builder(other);
